<script setup>
  import { ref } from 'vue'
  import addCategories  from './addCategory.vue';
  import updateCategories  from './updateCategory.vue';
  ...
  <div>
    <form action="POST">
      <div class="container-options-products">
        ...
        <div class="container-product-action" v-if="restaurantValue != null && actions.value === 'editar'">
    ...
    <div class="agregar" v-if="actionsValue == 'agregar' && restaurantValue != null">
      <addCategories
