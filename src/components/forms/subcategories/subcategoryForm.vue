<script setup>
  import { ref } from 'vue'
  import addCategory  from './addSubcategories.vue';
  import updateCategory  from './updateSubcategories.vue';
...
<template>
  <div>
    ...
    <div class="agregar" v-if="actionsValue == 'agregar' && restaurantValue != null && categoryValue != null">
      <addCategory
        :restaurant = 'restaurantValue'
        :category= 'categoryValue'
      />
    </div>
    <div class="editar" v-if="actionsValue == 'editar' && restaurantValue != null && categoryValue != null ">
      <updateCategory
        :restaurant = 'restaurantValue'
        :category= 'categoryValue'
      />
