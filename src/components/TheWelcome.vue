...
<template>
  <WelcomeItem>
    ...
    <template #heading>Restaurante</template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Categoría</template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Subcategoría</template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Platillos o productos</template>
  ...
  <WelcomeItem>
    ...
    <template #heading>Contenido multimedia</template>
